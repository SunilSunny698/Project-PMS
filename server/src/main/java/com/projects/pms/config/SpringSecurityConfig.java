package com.projects.pms.config;


import com.projects.pms.filter.JwtRequestFilter;
import com.projects.pms.filter.LoginFilter;
import com.projects.pms.filter.RestAuthenticationEntryPoint;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/register","/hi").permitAll()
