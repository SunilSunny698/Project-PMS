...
export const Table = <T extends object>({fetchHandler, data, columns,label,view=true,edit=true,del=true,all=true,deleteHandler,viewHandler}: ReactTableProps<T>) => {
        ...
        <div className="container mb-20 mt-[100px]  mx-auto px-2 sm:px-8 pt-">
                ...
                <div className="mx-auto inline-block rounded overflow-hidden sm:w-full md:w-full">
                    ...
                    <thead>
                        {table.getHeaderGroups().map((headerGroup) => (
                            <tr key={headerGroup.id} className='hover:bg-secondary bg-primary'>
            ...
            <div className="flex justify-center">
                ...
                <div className=' ml-3'>
                    ...
                    {[5,10,15,20,25,30,35].map((pageSize) => (
